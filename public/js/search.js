...
async function lowSugarAPI() {
  const baseURL = `https://api.edamam.com/search?q=""&app_id=${APP_ID}&app_key=${APP_key}&from=0&to=3&health=low-sugar`;
  const response = await fetch(baseURL);
  const data = await response.json();
...
async function BreakfastAPI() {
  const baseURL = `https://api.edamam.com/search?q=""&app_id=${APP_ID}&app_key=${APP_key}&from=0&to=3&mealType=breakfast`;
  const response = await fetch(baseURL);
  const data = await response.json();
...
async function LunchAPI() {
  const baseURL = `https://api.edamam.com/search?q=""&app_id=${APP_ID}&app_key=${APP_key}&from=0&to=3&mealType=lunch`;
  const response = await fetch(baseURL);
  const data = await response.json();
  lunchHTML(data.hits);
  console.table(data);
...
async function SnackAPI() {
  const baseURL = `https://api.edamam.com/search?q=""&app_id=${APP_ID}&app_key=${APP_key}&from=0&to=3&mealType=snack`;
  const response = await fetch(baseURL);
  const data = await response.json();
  SnackHTML(data.hits);
  console.table(data);
